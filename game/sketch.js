...
function keyPressed() {
  ...
  for (var i = notes.length - 1; i >= 0; i--) {
    ...
    if (n.lane === pressed && abs(n.y - hitLineY) < 30) {
      notes.splice(i, 1);
      score += 100;
      return;
    }
...
//function keyPressed() {
//  let t = Math.floor(getSongTime());
//
//  if (['a','f','j',';'].includes(key.toLowerCase())) {
//    console.log(`{ time: ${t}, lane: '${key.toLowerCase()}' },`);
//  }
//}
